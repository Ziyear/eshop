 ...
 * 通用类
 *
 * @author SuperZiyear@163.com
 */
public class PublicTimeUtils {
     ...
     * */
    public static Date pStringToDate(String dateStr, String pattern)
            throws ParseException {
    ...
    public static String dateFormat(Date date) {
        ...
        return PublicTimeUtils.date.format(date);
    }
     ...
     * @throws ParseException
     * */
    public static Date fDate(Date date) throws ParseException {
        String dateStr = PublicTimeUtils.date.format(date);
        return PublicTimeUtils.date.parse(dateStr);
    }
     ...
     * @throws ParseException
     * */
    public static String getFormatStringDay(String srcStr) throws ParseException {
        Date date = datetime.parse(srcStr);
        return datetime.format(date);
    }
     ...
     * @return boolean
     */
    public static boolean isNullOrNone(String srcStr) {
     ...
     * @return String
     */
    public static String showCount(String srcStr) {
        if (srcStr != null) {
            if (srcStr.length() > 25) {
                srcStr = srcStr.substring(0, 25);
                srcStr = srcStr + "...";
            }
        } else {
            srcStr = "";
